...
public class HIDDeviceManager {
    ...
    private boolean mBluetoothInitializationRequested;
    ...
    private boolean hasBluetoothPermission() {
        ...
        return mContext.getPackageManager().checkPermission(
                Manifest.permission.BLUETOOTH, mContext.getPackageName()) ==
                PackageManager.PERMISSION_GRANTED;
    }

    public static void retryBluetoothInitializationAfterPermissionGrant() {
        if (sManager != null && sManager.mBluetoothInitializationRequested) {
            sManager.initializeBluetooth();
        }
    }
    ...
    private void initializeBluetooth() {
        mBluetoothInitializationRequested = true;
        ...
        if (!hasBluetoothPermission()) {
            Log.d(TAG, "Couldn't initialize Bluetooth, missing Bluetooth permission");
            return;
        }

        if (!mContext.getPackageManager().hasSystemFeature(PackageManager.FEATURE_BLUETOOTH_LE)) {
            Log.d(TAG, "Couldn't initialize Bluetooth because the device does not support Bluetooth LE");
            return;
        }
    ...
    public void chromebookConnectionHandler() {
        if (!mIsChromebook || !hasBluetoothPermission() || mBluetoothManager == null) {
            return;
        }
    ...
    public boolean connectBluetoothDevice(BluetoothDevice bluetoothDevice) {
        if (!hasBluetoothPermission() || bluetoothDevice == null) {
            return false;
        }
    ...
    public boolean isSteamController(BluetoothDevice bluetoothDevice) {
        ...
        if (bluetoothDevice == null || !hasBluetoothPermission()) {
            return false;
        }
