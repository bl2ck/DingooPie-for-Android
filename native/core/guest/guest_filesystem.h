#ifndef DINGOO_PIE_GUEST_GUEST_FILESYSTEM_H
#define DINGOO_PIE_GUEST_GUEST_FILESYSTEM_H
...
extern bool fsys_read_cached(uint32_t stream, uint32_t size, uint32_t count, void* destination, uint32_t* bytesRead, uint32_t* itemsRead);
