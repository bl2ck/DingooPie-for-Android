...
const wchar_t* androidMenuText(UiLanguage language, AndroidMenuTextId id)
{
    ...
    case ANDROID_TEXT_INPUT_VIRTUAL_CONTROL_OPACITY:
        return zh ? L"\u865a\u62df\u6309\u952e\u900f\u660e\u5ea6" : L"Virtual Control Opacity";
    ...
    case ANDROID_TEXT_HELP_AUTHOR_HOMEPAGE:
        return zh ? L"\u4f5c\u8005\u4e3b\u9875" : L"Author Homepage";
    case ANDROID_TEXT_HELP_PROJECT_HOMEPAGE:
        return zh ? L"\u9879\u76ee\u4e3b\u9875" : L"Project Homepage";
